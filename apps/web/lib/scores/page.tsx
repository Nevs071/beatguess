...
import { clearScoreHistory, readScoreHistory, type ScoreHistoryItem } from '@/lib/score-history';
        ...
        <div className="mt-10 rounded-[2rem] border border-zinc-800 bg-zinc-950 p-8">
          ...
          {history.length === 0 ? (
            ...
            <div className="mt-10 overflow-hidden rounded-3xl border border-zinc-800">
              <div className="hidden grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr_1fr_1fr] gap-4 border-b border-zinc-800 bg-black px-5 py-4 text-sm font-bold text-zinc-400 md:grid">
              ...
              <div className="divide-y divide-zinc-800">
                {history.map((item) => (
                  <div
                    key={item.id}
                    className="grid gap-4 bg-zinc-950 px-5 py-5 md:grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr_1fr_1fr]"
                  >
                    <div>
